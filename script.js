...
function begin() {
  ...
  x[20].innerHTML = '<img height="70px" src="image/horse-1.jpg">';
  x[40].innerHTML = '<img height="70px" src="image/horse-2.jpg">';
  (i = 20), (j = 40);
...
function btnClick1() {
  ...
  if (i < 39) {
    ...
    x[i].innerHTML = '<img height="70px" src="image/horse-shadow.jpg">';

    i = i + shagaiOrhih();

    if (i >= 39) {
      document.getElementById("p1").innerHTML = "ялагч боллоо";
      x[39].innerHTML = '<img height="70px" src="image/horse-1.jpg">';
      document.getElementById("btnClick1").remove();
      document.getElementById("btnClick2").disabled = true;
      document.getElementById("player-1").style.color = "red";
    } else {
      x[i].innerHTML = '<img height="70px" src="image/horse-1.jpg">';
...
function btnClick2() {
  ...
  if (j < 59) {
    x = document.getElementById("mytable").getElementsByTagName("td");
    x[j].innerHTML = '<img height="70px" src="image/horse-shadow.jpg">';

    j = j + shagaiOrhih();

    if (j >= 59) {
      document.getElementById("p2").innerHTML = "ялагч боллоо";
      x[59].innerHTML = '<img height="70px" src="image/horse-2.jpg">';
      document.getElementById("btnClick1").disabled = true;
      document.getElementById("btnClick2").remove();
      document.getElementById("btnClick1").disabled = true;
      document.getElementById("player-2").style.color = "red";
    } else {
      x[j].innerHTML = '<img height="70px" src="image/horse-2.jpg">';
